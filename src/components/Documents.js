...
function Documents() {
    ...
    var locpath = String(location.pathname);
    var customer_id = parseInt(locpath.slice(locpath.length - 1));
    const [customer, setCustomer] = useState([]);


    useEffect(() => {
        fetch(`http://127.0.0.1:8004/api/applications/customer/${customer_id}`, {
          'method':'GET',
          headers: {
