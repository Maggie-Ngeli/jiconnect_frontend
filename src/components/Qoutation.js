            ...
            <Row>
                <Col xs={12} md={6} lg={6}>
                    <InfoContainer>
                        ...
                        <hr />
                        <Link to="/payments">
                            <a className="deatilsbtn">Back</a>
                        </Link>
                    </InfoContainer>
                </Col>
                <Col xs={12} md={6} lg={6}>
                    <InfoContainer>
                            <span><p>{application.ref_number} Qoutation</p></span>
                            <br/>
                            <a onClick={handleProposalShow}>View Qoute</a>
                            <Modal show={proposalshow} onHide={handleProposalClose}>
                                <Modal.Header closeButton>
                                <Modal.Title>Qoutation</Modal.Title>
                                </Modal.Header>
                                <Modal.Body>
                                    <img src={application.qoutation} width="470px"/>
                                </Modal.Body>
                                <Modal.Footer>
