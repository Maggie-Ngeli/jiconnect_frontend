...
function Designer() {
    ...
    const [appstatus, setAppStatus] = useState('On Design');
    


    useEffect(() => {
        fetch('http://127.0.0.1:8004/api/applications/applications/designer/', {
            'method':'GET',
            headers: {
    ...
    function getBase64(file, applicationid) {
        ...
        reader.onload = function () {
          APIService.UpdateApplication(applicationid, {
            "id": applicationid,
            "proposal": reader.result,
            "app_status": "Waiting for Qoute",

          })
          .then(() => setAppStatus("Waiting for Qoute"))
          .catch(error => console.log(error))
        ...
        <FilterContainers className="d-block">
                <FilterNav className="d-flex"> 
                    ...
                    <div className="d-flex">
                            <Link to="/applications/designer" onClick={() => setCounties('all')}><a className="browse_category active_category cat_all">All</a></Link>
                            <Link to="/applications/designer/mombasa" onClick={() => setCounties('mombasa')}><a className="browse_category cat_mombasa">Mombasa</a></Link>
                            <Link to="/applications/designer/kwale" onClick={() => setCounties('kwale')}><a className="browse_category cat_kwale">Kwale</a></Link>
                            <Link to="/applications/designer/kalifi" onClick={() => setCounties('kalifi')}> <a className="browse_category cat_kalifi">Kalifi</a></Link>
                            <Link to="/applications/designer/tanariver" onClick={() => setCounties('tanariver')}><a className="browse_category cat_tanariver">Tana River</a></Link>
                            <Link to="/applications/designer/taitataveta" onClick={() => setCounties('taitataveta')}><a className="browse_category cat_taitataveta">Taita Taveta</a></Link>
                        </div>
                    </FilterCategories>
                    ...
                    <tr key = {application.id}>
                        ...
                        <td>
                            <Link to={`/applications/note/${application.id}`}>
                              <a className="docs_btn">Add Tech Details</a>
                            </Link>
                        </td>
                        <td>
